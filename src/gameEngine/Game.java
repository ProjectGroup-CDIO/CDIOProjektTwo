...
public void game(){
	...
	GUI.addPlayer(playerTwoName, playerTwoPoints, 255, 255, 255); // De tre sidste tal angiver farve pï¿½ bilen
	GUI.addPlayer(playerOneName, playerOnePoints, 0, 0, 0);	  // De tre sidste tal angiver farve pï¿½ bilen   
